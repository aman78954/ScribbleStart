...
// Utility function to truncate content to a specified word limit
function truncateContent(html, wordLimit) {
    const text = stripHtmlTags(html); // Remove HTML tags
    const words = text.split(/\s+/); // Split by whitespace
    if (words.length > wordLimit) {
        return words.slice(0, wordLimit).join(' ') + '...'; // Return first 40 words with ellipsis
    }
    return text; // Return full text if less than 40 words
}
